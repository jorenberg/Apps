...
// Apps®
// ~~~~~
// Applications and KnowledgeBases of Sequømics Corporation.
//
// Version    : v1.0.0
// Build      : Himalaya
// Mode       : -//-Production-//-
...
Notice:- Explicitly declared only to use Apps®, within the company, organisation, and it's open source projects.
